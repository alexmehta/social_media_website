                        ...
                        <form action="edit-about.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="three-of-four">
                                    <input name="phone_number" type="text" value="<?php echo $db_user_data['phone_number'];?>" class="about__details-phone-form">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="three-of-four">
                                    <input name="email" type="email" value="<?php echo $db_user_data['email'];?>"class="about__details-phone-email">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="three-of-four">
                                    <input name= 'gender' value = 'male' type="radio" <?php echo $db_user_data['gender'] === 'male' ? 'checked' : ''; ?>> Male
                                    <br>
                                    <input name= 'gender' value="female" type="radio" <?php echo $db_user_data['gender'] === 'female' ? 'checked' : ''; ?>> Female
                                </div>
                            </div>
                            ...
                            <div class="row about__edit-btn">
                                ...
                                <div class="three-of-four">
                                    <button type="submit" name="submit" class="about__details-btn">Update</button>
                                </div>
                            </div>
